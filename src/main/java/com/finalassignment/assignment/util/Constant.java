...
public class Constant {
    ...
    public static final String itemFound = "All items found";
    ...
    public static final  String cartFound = "Cart found";
    public static final String cardNotFoundById = "Not found cart by id";
